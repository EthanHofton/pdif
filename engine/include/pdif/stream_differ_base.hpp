...
public:
     ...
     */
    stream_differ_base(const pdif::stream& stream1, const pdif::stream_meta& stream1_meta, const pdif::stream& stream2, const pdif::stream_meta& stream2_meta) : stream1(stream1), meta1(stream1_meta), stream2(stream2), meta2(stream2_meta) {}
